...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    <select
        ...
        data-dependencies="{{ isset($field['dependencies'])?json_encode($field['dependencies']): json_encode([]) }}"
    ...
    {{-- adding input type select has attribute readonly-hidden --}}
    @if(isset($field['attributes']['readonly_hidden']))
